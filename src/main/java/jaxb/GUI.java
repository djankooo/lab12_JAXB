...
public class GUI extends Application {
    ...
    private final ObservableList<Product> data
            = FXCollections.observableArrayList(new Product(BigDecimal.valueOf(1), "asd", BigDecimal.valueOf(12), BigDecimal.valueOf(13),BigDecimal.valueOf(14),BigDecimal.valueOf(1)));
